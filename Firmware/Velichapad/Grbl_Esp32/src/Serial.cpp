/*
  ...
  Copyright (c) 2014-2016 Sungeun K. Jeon for Gnea Research LLC
    ...
    2025 -  Saheen palayi, This file modified for adding Second serial port 
            for the Velichapad CNC machine.
...
void client_init() {
    ...
    #ifdef UART1_ENABLE
        Uart1.setPins(UART1_TX_PIN, UART1_RX_PIN);  // Tx GPIO22, Rx GPIO32 - standard hardware pins
        Uart1.begin(UART1_BAUDRATE, Uart::Data::Bits8, Uart::Stop::Bits1, Uart::Parity::None);
    #endif
    client_reset_read_buffer(CLIENT_ALL);
    Uart0.write("\r\n");  // create some white space after ESP32 boot info
#endif
